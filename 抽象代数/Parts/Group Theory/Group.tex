...
\begin{proposition}[The subgroup criterion]
    ...
    \begin{enumerate}
        ...
        \item
              If $\mathcal{B}$ is a chain (with respect to set inclusion) in the family of all subgroups of $G$, then the union of all members in $\mathcal{B}$ is also a subgroup of $G$
    \end{enumerate}
\end{proposition}
\begin{proposition}
...
\begin{definition}
    ...
    \begin{enumerate}
        ...
        \item
              The action of $G$ on $X$ is called \textbf{transitive} if there is only one orbit of $G$.
    \end{enumerate}
\end{definition}
