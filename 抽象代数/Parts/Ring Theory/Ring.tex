...
\begin{definition}
    Let $A$ be a ring.
    If there is a least positive integer $n$ such that $nr=0$ for all $r \in A$, then $A$ is said to have \textbf{characteristic} $n$ . If no such $n$ exists $A$ is said to have characteristic zero. (Notation: $\char{A}={n}$).
\end{definition}
