...
\begin{proposition}
    ...
    \begin{equation*}
        ...
        \lesssim
        \frac{1}{|x|^{n-1}},
        \left|D^2 \Phi(x)\right| \lesssim \frac{1}{|x|^n} \quad(x \neq 0)
    \end{equation*}
    $\mathbf{D}$
...
\begin{theorem}
    Assume that $f \in C_c^2\left(\mathbb{R}^n\right)$.
    Define $u$
    \begin{equation*}
        u(x)
        :=
    ...
    \begin{enumerate}
        \item
              $u \in C^2\left(\mathbb{R}^n\right)$


        \item
              $-\Delta u=f$ in $\mathbb{R}^n$.
    \end{enumerate}
...
\begin{theorem}[Mean-value formulas]
    Consider now open set $U \subset \mathbb{R}^n$ and $u \in C^2(U)$
    is harmonic, then
    \begin{equation*}
        u(x)=\fint_{\partial B(x, r)} u(y)\d S =\fint_{B(x, r)} u(y) \d y
    \end{equation*}
    ...
    \begin{proof}
        ...
        \begin{equation*}
            \phi(r)
            :=
            \fint_{\partial B(x, r)} u(y) \d S
            =
            \fint_{\partial B(0, 1)} u(x+rz) \d S(z)
        \end{equation*}
        Then
        \begin{equation*}
            \begin{aligned}
                \phi^{\prime}(r) & =\fint_{\partial B(0, 1)} Du(x+rz)\cdot z \d S(z)                   \\
...
\begin{corollary}
    [Converse to mean-value property]
...
\begin{theorem}[Strong maximum principle]
    ...
    \begin{enumerate}
        \item
              ...
              \end{equation*}
        \item
              Furthermore, if $U$ is connected and there exists a point $x_0 \in U$ such that
              \begin{equation*}
...
\begin{definition}
    The \textbf{Green's function} for the region $U$ is
    \begin{equation*}
...
\begin{theorem}[Poisson's formula for half-space]
    ...
    \begin{enumerate}
        \item
              $u \in C^{\infty}\left(\mathbb{R}_{+}^n\right) \cap L^{\infty}\left(\mathbb{R}_{+}^n\right)$,

        \item
              $\Delta u=0$ in $\mathbb{R}_{+}^n$,

        \item
              $\lim\limits _{\substack{x \rightarrow x^0 \\ x \in \mathbb{R}_{+}^n}} u(x)=g\left(x^0\right)$ for each point $x^0 \in \partial \mathbb{R}_{+}^n$.
    \end{enumerate}
\end{theorem}
...
\begin{theorem}[Poisson's formula for ball]
    ...
    \begin{enumerate}
        \item
              $u \in C^{\infty}\left(B(0, r)\right)$

        \item   $\Delta u=0 $ in $B(0, r)$

        \item   $\lim\limits_{\substack{x \rightarrow x^0 \\ x \in B(0, r)}} u(x)=g\left(x^0\right)$ for each point $x^0 \in \partial B(0, r)$.
    \end{enumerate}
\end{theorem}
...
\begin{theorem}[Reflection principle]
    ...
    \begin{proof}
        Noted that $v\in C(\bar{U})$. Suppoes poission integral relative to $v$
        \begin{equation*}
