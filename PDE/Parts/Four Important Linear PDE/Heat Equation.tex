...
\begin{theorem}[Solution of initial-value problem]
    ...
    \begin{enumerate}
        ...
        \item
              $u_t(x, t)-\Delta u(x, t)=0 \quad\left(x \in \mathbb{R}^n, t>0\right)$

        \item
              $\lim\limits_{\substack{(x, t) \rightarrow(x^0, 0) \\ x \in \mathbb{R}^n, t>0}} u(x, t)=g\left(x^0\right)$ for each point $x^0 \in \mathbb{R}^n$.
    \end{enumerate}
...
\begin{theorem}[Solution of nonhomogeneous problem]
    ...
    \begin{enumerate}
        \item
              $u \in C_1^2\left(\mathbb{R}^n \times(0, \infty)\right)$,

        \item  $u_t(x, t)-\Delta u(x, t)=f(x, t) \quad\left(x \in \mathbb{R}^n, t>0\right)$,

        \item  $\lim\limits_{\substack{(x, t) \rightarrow\left(x^0, 0\right) \\ x \in \mathbb{R}^n, t>0}} u(x, t)=0 \quad$ for each point $x^0 \in \mathbb{R}^n$.
    \end{enumerate}
    \begin{proof}
