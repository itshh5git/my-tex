...
\begin{corollary}
    Consider the regular representation of $G$ over $k$.
    Then each irreducible representation $V_i$ appears in it with multiplicity equal to its degree $n_i=\dim V_i$.
    \begin{equation*}
        {}_{k[G]} k[G] \cong \bigoplus_{i=1}^h  V_i^{\oplus n_i} .
    \end{equation*}
\end{corollary}
